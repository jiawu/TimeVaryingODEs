...
def system(y,t,mat,par):
    ...
    #see above.
    return [sum([hill(i,j)*k for i,j,k in zip(y,x[2],x[3])])-x[0]*x[1]+pulse(pulses[n]) for n,x in enumerate(zip(dec, y, par, mat))]

    #A pulse to be used as inputs to nodes
def pulse(pulse_pars):
...
if __name__ == "__main__":
    ...
    head = "/Users/jjw036/TimeVaryingODEs/output"
